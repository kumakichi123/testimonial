    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            外壁塗装の「取りこぼし電話」<br />1日何件ありますか？
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-blue-100">
            現場に出ている間の電話。夜8時、土曜日の昼、日曜の夕方。<br />
            「留守電に入ってたけど、折り返したら繋がらない」<br />
            「次の日に電話したら、もう他社で契約してた」
          </p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>「〇〇塗装でございます」と名乗って一次受付</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="mr-2 text-green-500 flex-shrink-0 mt-1" size={20} />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 bg-white rounded-lg shadow p-6">
            ...
            <ul className="space-y-2 text-gray-700 text-sm md:text-base">
              ...
              <li>・外壁塗装に特化したテンプレートで、設定やカスタマイズの工数を減らしています。</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-indigo-600 to-slate-800 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">導入相談・デモの予約はこちら</h2>
          <p className="text-lg md:text-xl text-indigo-100">
            ご都合のいいタイミングで、使い方や導入ステップをご案内します。
            お問い合わせフォームまたはLINEでお問い合わせいただけます。
          </p>
      ...
      <footer className="bg-gray-800 text-white py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="mb-4">外壁塗装業者向けAI電話受付サービス</p>
