    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            リフォームの「取りこぼし電話」<br />1日何件の新規客が流れていますか？
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-blue-100">
            現場や打ち合わせ中の着信。工事開始直前や週末。<br />
            「留守電に入ってたけど、折り返したら担当が手一杯」<br />
            「翌日には他社で内装を決めていた」
          </p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>「〇〇リフォームでございます」と名乗って一次受付</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="mr-2 text-green-500 flex-shrink-0 mt-1" size={20} />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 bg-white rounded-lg shadow p-6">
            ...
            <ul className="space-y-2 text-gray-700 text-sm md:text-base">
              ...
              <li>・リフォームに特化したテンプレートで、設定やカスタマイズの工数を減らしています。</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-indigo-600 to-slate-800 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">リフォーム業者向け導入相談はこちら</h2>
          <p className="text-lg md:text-xl text-indigo-100">
            ご都合のいいタイミングで、リフォーム現場に合った使い方や導入ステップをご案内します。
      ...
      <footer className="bg-gray-800 text-white py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="mb-4">リフォーム業者向けAI電話受付サービス</p>
